...
| POS | Facturación POS pendiente de timbrado | Implementado MVP | Media | POS F7 | `POS > Facturación` ya lista solicitudes en `pendiente_datos` o `lista_para_facturar` con filtros operativos. | Sin bandeja fiscal operativa, las solicitudes se pierden entre ventas e historial. |
