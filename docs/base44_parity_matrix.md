...
| PM / Inventario | Requisiciones desde PM | Pendiente | Media | Inventario-PM futura | Ya existe requisición básica, pero no un flujo completo de surtido, reserva y compra desde la planeación PM. | Materiales planeados sin abastecimiento integral. |
| PM / Inventario | Órdenes de compra desde requisición | Pendiente | Media | Inventario-PM futura | No existe todavía continuidad automática desde requisición de proyecto hasta orden de compra. | Flujo operativo fragmentado entre PM e inventario. |
