...
| PM | Gantt editable básico | Implementado | Media | PM F7 | El Gantt ya permite abrir edición de fechas y aplicar sugerencias desde cada tarea, sin drag and drop. | La edición sigue siendo modal y no sobre la barra directamente. |
...
| PM | Drag and drop Gantt | Pendiente | Media | PM futura | No implementado en kanban ni Gantt. | Replaneacion visual menos agil. |
