...
| Empresa / POS | Uso en tickets POS | Pendiente | Baja | Branding futura | `/me` ya expone branding, pero el ticket POS no se ajusta visualmente en esta fase. | El ticket sigue mostrando encabezado textual actual. |
